...
**任務**:把你在模組 1 做的頁部署到 GitHub Pages,拿到網址後貼到 LINE 傳給自己。
**預期成果**:用無痕視窗開那個真實網址打得開;在 LINE 裡的分享卡出現你的 OG 標題和圖。
**卡關怎麼辦**:404 多半是 `index.html` 沒放在 repo 根目錄;分享卡沒圖,檢查 `og:image` 是不是完整的 https 網址。
